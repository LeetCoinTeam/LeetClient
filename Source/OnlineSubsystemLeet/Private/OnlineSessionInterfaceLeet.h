 ...
 */
class FOnlineSessionLeet : public IOnlineSession
{
private:
	 ...
	 */
	void AppendSessionToPacket(class FNboSerializeToBufferLeet& Packet, class FOnlineSession* Session);
	 ...
	 */
	void AppendSessionSettingsToPacket(class FNboSerializeToBufferLeet& Packet, FOnlineSessionSettings* SessionSettings);
	 ...
	 */
	void ReadSessionFromPacket(class FNboSerializeFromBufferLeet& Packet, class FOnlineSession* Session);
	 ...
	 * @param SessionSettings the session settings to copy the data to
	 */
	void ReadSettingsFromPacket(class FNboSerializeFromBufferLeet& Packet, FOnlineSessionSettings& SessionSettings);
	 ...
	 */
	static void SetPortFromNetDriver(const FOnlineSubsystemLeet& Subsystem, const TSharedPtr<FOnlineSessionInfo>& SessionInfo);
...
PACKAGE_SCOPE:
	...
	FOnlineSessionLeet(class FOnlineSubsystemLeet* InSubsystem) :
...
typedef TSharedPtr<FOnlineSessionLeet, ESPMode::ThreadSafe> FOnlineSessionLeetPtr;
